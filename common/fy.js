...
(function () {
  ...
  window.print = function (t) {
    return process.stdout.write(
      (t != null ? t.toString() : void 0) || JSON.stringify(t)
    );
  };
  ...
  window.h_count = window.count_h = window.hash_count = window.count_hash = function (
    t
  ) {
    var k, ret;
    ret = 0;
  ...
  Function.prototype.sbind = function () {
    ...
    (athis = arguments[0]),
      (main_rest = 2 <= arguments.length ? __slice.call(arguments, 1) : []);
    __this = this;
    ret = function () {
      var rest;
    ...
    ret.call = function () {
      var rest, _new_athis;
      (_new_athis = arguments[0]),
        (rest = 2 <= arguments.length ? __slice.call(arguments, 1) : []);
